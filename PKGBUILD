...
source=(
  "${url}/unifont-${pkgver}/unifont-${pkgver}.bdf.gz"{,.sig}
  "LICENSE"
)
validpgpkeys=(
...
sha512sums=(
  '342c288fd5b5e90085254bed36a61a58ec1fc48437c1f65240295deb53fde18db241c95db4d47d5308f47dbe56fbea79f9c6b9494e81ee2ad11cb91997e220e4'
  'SKIP'
...
package() {
  gzip \
    -d \
    --force \
    "${srcdir}/unifont-${pkgver}.bdf.gz"
  install \
    -Dm644 \
    "${srcdir}/unifont-${pkgver}.bdf" \
